#!/bin/bash
#
# Install git hooks for redskull development
#
...
echo "Installing git hooks for redskull..."

# Verify we're in the right place
if [[ ! -f "${REPO_ROOT}/Cargo.toml" ]]; then
    echo "Error: Must be run from the redskull repository"
    exit 1
fi
...
echo "  REDSKULL_PRECOMMIT_TEST=1 git commit"
echo ""
